...
>
    ...
    <div class="form-group">
        ...
        >
            ...
            <option
                value="normal"
                {{ old('condition', 'normal') == 'normal' ? 'selected' : '' }}
            >
                Normal
            </option>
    ...
    <div class="form-group">
        ...
        <small class="form-text text-muted">
            Maksimal 3 foto. Format JPG, JPEG, PNG atau WEBP.
    ...
    {{-- BUTTON --}}
    <div class="airnav-inventory-form-actions">

      <button
    type="button"
    class="airnav-inventory-save"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    */
    ...
    if (serialContainer && addSerial) {

        addSerial.addEventListener('click', function () {
        ...
        document.addEventListener('click', function (event) {
            ...
            const removeButton =
                event.target.closest('.remove-serial');
    ...
    */
    ...
    const photoLabel =
        document.querySelector('label[for="photos"]');

    const preview =
        document.getElementById('photo-preview');


    if (photoInput && photoLabel && preview) {
